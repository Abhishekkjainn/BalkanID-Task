    ...
    <div className="banner">
                <div className="banner-content">
                    ...
                    <div className="banner-actions">
                        {user ? (<><Link to={'/login'} className="primbutton1">Go to Dashboard</Link> <a href='https://documenter.getpostman.com/view/39857190/2sB3HtFwWi' className="button2">Documentation</a></>) : (<>
